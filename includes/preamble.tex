...
\lstset{
 morekeywords={if, else, fun, val, var, get, set, data, enum, when, inline, object, infix, override, is, lateinit, companion}
}
\lstset{
...
%    basicstyle=\small\ttfamily,%
    ...
    %NO ... numbers=left, numberstyle=\tiny, stepnumber=1, numbersep=5pt,%
    numbers=none,
